  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl w-full mx-auto">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 border-b border-slate-200 pb-4">
        <div>
          <h2 className="text-2xl font-extrabold text-slate-900 tracking-tight">Book a room</h2>
          <p className="text-sm text-slate-500 mt-1">Each slot is 40 minutes. Bookings require admin approval.</p>
        </div>
