...
import { 
  Upload, Send, Trash2, CheckCircle2, AlertCircle, MessageSquare, BarChart3
} from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto pt-8 pb-16 px-2 sm:px-4 md:px-6 space-y-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl shadow-xs p-4 sm:p-6">
            ...
            <form onSubmit={handleCreatePost} className="space-y-4">
              ...
              <button className="w-full bg-[#521956] hover:bg-purple-900 text-white text-xs font-bold py-3 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 template-btn" type="submit" disabled={isSubmitting}>
